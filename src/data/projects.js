...
export const projects = [
  {
    ...
    category: 'Web Design',
    description: 'A premium food & restaurant brand experience with immersive visuals.',
  ...
  },
  {
    ...
    category: 'Web Design',
    description: 'Luxury fashion e-commerce platform with elegant product showcases.',
  ...
  },
  {
    ...
    category: 'Web Design',
    description: 'A fintech × edtech platform for SIEC Group — helping Indian students finance overseas education with 50+ lending partners.',
    ...
    showcaseImages: [
      { 
        ...
        explanation: 'Deep navy background establishes security and corporate trust instantly. Clean typography with a single primary yellow CTA focuses the user journey on conversion, complemented by floating quick-value badges and key partner logos immediately below.'
      },
      { 
        src: salServicesScr, 
        label: 'Special Services Section',
        explanation: 'A tabbed category layout that minimizes page length and clutter. Users can switch between Education Loans, Accommodation, and Forex. The active container integrates direct bulleted value propositions and verified social proof testimonial in a single card.'
      },
      { 
        src: salProfilesScr, 
        label: 'Borrower Profiles Considered',
        explanation: 'Color-coded headers and distinct typography for various applicant types (NRIs, Self-Employed, Salaried). This structured visual hierarchy allows different user personas to self-identify their path and eligibility immediately without reading dense text.'
      },
      { 
        src: salTestimonialsScr, 
        label: 'Customer Testimonials',
        explanation: 'A clean, high-contrast grid display of real student success stories. Star ratings and card container borders maintain readability on dark backgrounds, helping validate trust and remove anxiety associated with loan approval.'
      },
      { 
        src: salFooterScr, 
        label: 'Lead Capture & Footer Integration',
        explanation: 'A high-converting, focused contact card form asking for minimal details to connect with a loan advisor. Below it, a well-organized multi-column footer lists navigation links, legal information, and partner offices clearly.'
      }
    ],
    palette: [
    ...
    features: [
      { title: 'Competitive Interest Rates', desc: 'Partnered with 50+ top Indian & international banks for the lowest ROI.' },
      { title: '100% Course Funding', desc: 'Covers tuition, accommodation, and living expenses for 11 countries.' },
      { title: 'Dedicated Loan Experts', desc: 'Every applicant gets a personal loan advisor from start to finish.' },
      { title: '5 Borrower Profiles', desc: 'NRIs, Salaried, Self-Employed, Business Owners & Agricultural — each with tailored eligibility.' },
      { title: '3-Step Apply Flow', desc: 'Check eligibility → Get best rate → Submit documents. No hidden catches.' },
      { title: 'End-to-End Assistance', desc: 'From eligibility check through application to disbursement — fully guided.' },
    ],
  ...
  },
  {
    ...
    description: 'Music streaming platform with immersive audio-visual experience.',
