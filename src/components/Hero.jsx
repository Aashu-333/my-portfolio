            ...
            <div className="hero-content">
                ...
                <div className="hero-left" id="hero-left">
                    ...
                    <h1 className="hero-heading" id="hero-heading">
                        ...
                        <span className="big-text">
                            UI<span className="big-text-slash">/</span>UX
                        </span>
                        <br />
                ...
                <div className="hero-right" id="hero-right">
                    <p className="hero-description" id="hero-description">
                        Hi, I'm Aayush Kanojia — a creative designer passionate
                        about building modern digital experiences that combine
                    ...
                    <div className="hero-actions">
                        <a
                            ...
                            id="cta-resume"
                            aria-label="Open Aayush Kanojia's resume in a new tab"
                        >
